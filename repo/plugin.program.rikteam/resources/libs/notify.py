...
def firstRun():
    class MyWindow(xbmcgui.WindowXMLDialog):
        def __init__(self, *args, **kwargs):
            ...
            self.msg   = "No hay ninguna build instalada de %s.\n\nSelecciona 'Build Menu' para instalar una Build o 'Ignore' para no volver a ver este mensaje.\n\nGracias por escogernos %s." % (ADDONTITLE, ADDONTITLE)
